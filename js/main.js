...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (e) {
    ...
    n.VERSION = "3.3.7", n.DEFAULTS = {
        ...
        t += "Text", null == s.resetText && r.data("resetText", r[i]()), setTimeout(e.proxy(function () {
            r[i](null == s[t] ? this.options[t] : s[t]), "loadingText" == t ? (this.isLoading = !0, r.addClass(n).attr(n, n).prop(n, !0)) : this.isLoading && (this.isLoading = !1, r.removeClass(n).removeAttr(n).prop(n, !1))
        }, this), 0)
    ...
    function n(n) {
        n && 3 === n.which || (e(i).remove(), e(s).each(function () {
            ...
            i.hasClass("open") && (n && "click" == n.type && /input|textarea/i.test(n.target.tagName) && e.contains(i[0], n.target) || (i.trigger(n = e.Event("hide.bs.dropdown", s)), n.isDefaultPrevented() || (r.attr("aria-expanded", "false"), i.removeClass("open").trigger(e.Event("hidden.bs.dropdown", s)))))
        }))
    }
    ...
    o.VERSION = "3.3.7", o.prototype.toggle = function (r) {
        var i = e(this);
        if (!i.is(".disabled, :disabled")) {
            ...
            if (n(), !o) {
                ...
                i.trigger("focus").attr("aria-expanded", "true"), s.toggleClass("open").trigger(e.Event("shown.bs.dropdown", u))
            }
            return !1
        }
    ...
    n.VERSION = "3.3.7", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                ...
                u = "bottom" == u && h.bottom + d > m.bottom ? "top" : "top" == u && h.top - d < m.top ? "bottom" : "right" == u && h.right + p > m.width ? "left" : "left" == u && h.left - p < m.left ? "right" : u, s.removeClass(v).addClass(u)
            }
        ...
        if (this.$element.trigger(o), !o.isDefaultPrevented()) return s.removeClass("in"), e.support.transition && s.hasClass("fade") ? s.one("bsTransitionEnd", r).emulateTransitionEnd(n.TRANSITION_DURATION) : r(), this.hoverState = null, this
    ...
    n.VERSION = "3.3.7", n.RESET = "affix affix-top affix-bottom", n.DEFAULTS = {
        ...
        if ("bottom" == this.affixed) return null != n ? !(i + this.unpin <= s.top) && "bottom" : !(i + o <= e - r) && "bottom";
    ...
    function () {
        ...
        function R(e) {
            if (100 != e.get(In) && si(nt(e, Cn)) % 1e4 >= 100 * rt(e, In)) throw "abort"
        }

        function U(e) {
            if (C(nt(e, An))) throw "abort"
        }
        ...
        function W(e) {
            ...
            e.set(an, i(e), !0), e.set(St, rt(e, St) + 1);
            var r = [];
            et.map(function (t, n) {
                if (n.F) {
                    var i = e.get(t);
                    void 0 != i && i != n.defaultValue && ("boolean" == typeof i && (i *= 1), r.push(n.F + "=" + p("" + i)))
                }
            }), r.push("z=" + G()), e.set(bt, r.join("&"), !0)
        }
        ...
        function X(e) {
            ...
            } else P(t, nt(e, bt), e.get(yt));
            t = e.get(An), t = I(t), n = t.hitcount, t.hitcount = n ? n + 1 : 1, t = e.get(An), delete I(t).pending_experiments, e.set(yt, h, !0)
        }

        function V(e) {
            (x.gaData = x.gaData || {}).expId && e.set(Yt, (x.gaData = x.gaData || {}).expId), (x.gaData = x.gaData || {}).expVar && e.set(Zt, (x.gaData = x.gaData || {}).expVar);
            var t, n = e.get(An);
        ...
        function Y(e) {
            ...
            if ("transaction" != r && "item" != r) {
                var r = rt(e, un),
                    i = (new Date).getTime(),
                    s = rt(e, on);
                0 == s && e.set(on, i), s = Math.round(2 * (i - s) / 1e3), 0 < s && (r = Math.min(r + s, 20), e.set(on, i));
                if (0 >= r) throw "abort";
                e.set(un, --r)
            }
            e.set(sn, ++t)
        ...
        function Wn(e, t, r, i) {
            t[e] = function () {
                try {
                    return i && n(i), r.apply(this, arguments)
                } catch (t) {
                    throw F("exc", e, t && t.name), t
                }
            }
        }
        ...
        function fr(e, t, n) {
            ...
            if (0 != r.length) return 1 == r.length ? r[0] : lr(t, r) || lr(n, r) || lr(null, r) || r[0]
        }

        function lr(e, t) {
            var n, r;
            null == e ? n = r = 1 : (n = si(e), r = si(f(e, ".") ? e.substring(1) : "." + e));
        ...
        function dr(e, t) {
            for (var n = new Date, r = x.navigator, i = r.plugins || [], n = [e, r.userAgent, n.getTimezoneOffset(), n.getYear(), n.getDate(), n.getHours(), n.getMinutes() + t], r = 0; r < i.length; ++r) n.push(i[r].description);
            return si(n.join("."))
        }

        function yr(e, t) {
            if (t == T.location.hostname) return !1;
        ...
        function si(e) {
            var t = 1,
                n, r;
            if (e)
                for (t = 0, r = e.length - 1; 0 <= r; r--) n = e.charCodeAt(r), t = (t << 6 & 268435455) + n + (n << 14), n = t & 266338304, t = 0 != n ? t ^ n >> 21 : t;
            return t
        }
        var e = function (e) {
            this.w = e || []
        ...
        var t = new e,
            r = function (t, n) {
                var r = new e(s(t));
                r.set(n), t.set(fn, r.w)
            },
            i = function (n) {
                n = s(n), n = new e(n);
                for (var r = t.w.slice(), i = 0; i < n.w.length; i++) r[i] = r[i] || n.w[i];
                return (new e(r)).encode()
            },
            s = function (e) {
                return e = e.get(fn), u(e) || (e = []), e
            },
            o = function (e) {
            ...
            v = /^[\w\-:/.?=&%!]+$/,
            m = function (e, t, n) {
                e && (n ? (n = "", t && v.test(t) && (n = ' id="' + t + '"'), v.test(e) && T.write("<script" + n + ' src="' + e + '"></script>')) : (n = T.createElement("script"), n.type = "text/javascript", n.async = !0, n.src = e, t && (n.id = t), e = T.getElementsByTagName("script")[0], e.parentNode.insertBefore(n, e)))
            },
            g = function () {
            ...
            w = function (e) {
                ...
                if (/^https?:\/\//i.test(t)) {
                    ...
                    var n = t.indexOf(e);
                    if (5 == n || 6 == n)
                        if (e = t.charAt(n + e.length), "/" == e || "?" == e || "" == e || ":" == e) return;
                    return t
                }
            },
            E = function (e, t) {
                ...
                for (var n = {}, r = Math.min(e.length + 1, t.length), i = 0; i < r; i++) {
                    if ("object" == typeof t[i]) {
                        for (var s in t[i]) t[i].hasOwnProperty(s) && (n[s] = t[i][s]);
                        break
                    }
        ...
        var x = window,
            ...
            C = function (e) {
                ...
                if (t && t.ioo && t.ioo() || e && !0 === N["ga-disable-" + e]) return !0;
                try {
                    var n = N.external;
            ...
            L = function (e, t, r, i, s, o) {
                ...
                if (!s) return !1;
                t && 1200 < t.length && (t = t.substring(0, 1200), n(24)), r = e + "=" + t + "; path=" + r + "; ", o && (r += "expires=" + (new Date((new Date).getTime() + o)).toGMTString() + "; "), i && "none" != i && (r += "domain=" + i + ";"), i = T.cookie, T.cookie = r;
                if (!(i = i != T.cookie)) e: {
                    e = k(e);
            ...
            P = function (e, t, n) {
                n = n || h;
                if (2036 >= t.length) H(e, t, n);
                else {
                    if (!(8192 >= t.length)) throw F("len", t.length), new D(t.length);
            ...
            j = function (e, t, n) {
                return x.navigator.sendBeacon ? x.navigator.sendBeacon(e, t) ? (n(), !0) : !1 : !1
            },
            F = function (e, t, n) {
                1 <= 100 * Math.random() || C("?") || (e = ["t=error", "_e=" + e, "_v=j47", "sr=1"], t && e.push("_f=" + t), n && e.push("_m=" + p(n.substring(0, 100))), e.push("aip=1"), e.push("z=" + Q()), H(_() + "/collect", e.join("&"), h))
            },
            I = function (e) {
        ...
        q.prototype.add = function (e) {
            ...
            t = e.get(yt), t != h && o(t) && (e.set(yt, h, !0), setTimeout(t, 10))
        };
        var Q = function () {
            ...
            G = function () {
                try {
                    ...
                    return x.crypto.getRandomValues(e), e[0] & 2147483647
                } catch (t) {
                    return Q()
                }
            },
        ...
        Z.prototype.get = function (e) {
            var t = ot(e),
                n = this.data.get(e);
            return t && void 0 == n && (n = o(t.defaultValue) ? t.defaultValue() : t.defaultValue), t && t.Z ? t.Z(this, e, n) : n
        };
        var nt = function (e, t) {
                var n = e.get(t);
                return void 0 == n ? "" : "" + n
        ...
        Z.prototype.set = function (e, t, n) {
            if (e)
                if ("object" == typeof e)
                    for (var r in e) e.hasOwnProperty(r) && it(this, r, e[r], n);
                else it(this, e, t, n)
        };
        var it = function (e, t, n, r) {
            ...
            at = function (e, t, n, r, i) {
                return e = new st(e, t, n, r, i), et.set(e.name, e), e.name
            },
            ft = function (e, t) {
        ...
        var mt = at("adSenseId", "a"),
            ...
            yt = at("hitCallback"),
            bt = at("hitPayload");
        at("nonInteraction", "ni"), at("currencyCode", "cu"), at("dataSource", "ds");
        var wt = at("useBeacon", void 0, !1),
            Et = at("transport");
        at("sessionControl", "sc", ""), at("sessionGroup", "sg"), at("queueTime", "qt");
        var St = at("_s", "_s");
        at("screenName", "cd");
        ...
        at("campaignId", "ci"), at("campaignName", "cn"), at("campaignSource", "cs"), at("campaignMedium", "cm"), at("campaignKeyword", "ck"), at("campaignContent", "cc");
        ...
        at("appName", "an"), at("appVersion", "av", ""), at("appId", "aid", ""), at("appInstallerId", "aiid", ""), at("exDescription", "exd"), at("exFatal", "exf");
        var Yt = at("expId", "xid"),
            Zt = at("expVar", "xvar"),
            en = at("exp", "exp"),
            tn = at("_utma", "_utma"),
        ...
        var cn = lt("_oot"),
            ...
            Vn = function (e, t) {
                ...
                e.$ = !0;
                if (t) {
                    if (e.oa && rt(t, e.oa)) return rt(t, e.oa);
                    if (0 == t.get(qn)) return 0
                }
                return 0 == e.V ? 0 : (void 0 === n && (n = G()), 0 == n % e.V ? Math.floor(n / e.V) % e.ea + 1 : 0)
            },
            Jn = function (e) {
            ...
            Kn = function (e) {
                ...
                if (Qn(t) || Gn(t)) {
                    var n = t[qt];
                    void 0 == n || Infinity == n || isNaN(n) || (0 < n ? (Yn(t, Ut), Yn(t, Xt), Yn(t, Wt), Yn(t, Rt), Yn(t, zt), Yn(t, Vt), Yn(t, $t), e(t)) : d(x, "load", function () {
                        Kn(e)
                    }, !1))
                }
            },
            Qn = function (e) {
                ...
                return 0 == n ? !1 : (e[qt] = t.loadEventStart - n, e[Ut] = t.domainLookupEnd - t.domainLookupStart, e[Xt] = t.connectEnd - t.connectStart, e[Wt] = t.responseStart - t.requestStart, e[Rt] = t.responseEnd - t.responseStart, e[zt] = t.fetchStart - n, e[Vt] = t.domInteractive - n, e[$t] = t.domContentLoadedEventStart - n, !0)
            },
            Gn = function (e) {
                if (x.top != x) return !1;
                var t = x.external,
                    n = t && t.onloadT;
                return t && !t.isValidLoadTime && (n = void 0), 2147483648 < n && (n = void 0), 0 < n && t.setPageReadyTime(), void 0 == n ? !1 : (e[qt] = n, !0)
            },
            Yn = function (e, t) {
                var n = e[t];
                if (isNaN(n) || Infinity == n || 0 > n) e[t] = void 0
            },
            Zn = function (e) {
                return function (t) {
                    if ("pageview" == t.get(gt) && !e.I) {
                        e.I = !0;
                        var n = Jn(t);
                        t = 0 < y(t.get(xt), "gclid").length, (n || t) && Kn(function (t) {
                ...
                if ("cookie" == nt(e, Bn)) {
                    ...
                    if ("auto" != s) L(t, r, i, s, u, o) && (er = !0);
                        ...
                        e: {
                            r = [],
                            s = b().split(".");
                            if (4 == s.length && (a = s[s.length - 1], parseInt(a, 10) == a)) {
                                a = ["none"];
                                break e
                            }
                            for (a = s.length - 2; 0 <= a; a--) r.push(s.slice(a).join("."));r.push("none"),
                            a = r
                        }
                        for (var f = 0; f < a.length; f++)
                            if (s = a[f], e.data.set(Mn, s), r = ir(e), L(t, r, i, s, u, o)) {
                                er = !0;
                                return
                            } e.data.set(Mn, "auto")
                    }
            ...
            nr = function (e) {
                if ("cookie" == nt(e, Bn) && !er && (tr(e), !er)) throw "abort"
            },
            rr = function (e) {
                if (e.get(Hn)) {
                    var t = nt(e, Mn),
                        r = nt(e, Pn) || b(),
                        i = fr("__utma", r, t);
                    i && (n(19), e.set(rn, (new Date).getTime(), !0), e.set(tn, i.R), (t = fr("__utmz", r, t)) && i.hash == t.hash && e.set(nn, t.R))
                }
            },
            ir = function (e) {
                var t = A(nt(e, Cn)),
                    n = or(nt(e, Mn)).split(".").length;
                return e = ar(nt(e, _n)), 1 < e && (n += "-" + e), ["GA1", n, t].join(".")
            },
            sr = function (e, t, n) {
                for (var r = [], i = [], s, o = 0; o < e.length; o++) {
                    var u = e[o];
                    u.H[n] == t ? r.push(u) : void 0 == s || u.H[n] < s ? (i = [u], s = u.H[n]) : u.H[n] == s && i.push(u)
                }
            ...
            ar = function (e) {
                return e = ur(e), "/" == e ? 1 : e.split("/").length
            },
            cr = new RegExp(/^https?:\/\/([^\/:]+)/),
            hr = /(.*)([?&#])(?:_ga=[^&#]*)(?:&?)(.*)/,
            vr = function (e) {
        ...
        vr.prototype.ca = function (e, t) {
            if (e.tagName) {
                ...
                if ("form" == e.tagName.toLowerCase()) return gr(this, e)
            }
            if ("string" == typeof e) return mr(this, e, t)
        };
        var mr = function (e, t, n) {
                ...
                var i = t.indexOf("?"),
                    r = t.indexOf("#");
                return n ? t += (-1 == r ? "#" : "&") + e : (n = -1 == i ? "?" : "&", t = -1 == r ? t + (n + e) : t.substring(0, r) + n + e + t.substring(r)), t = t.replace(/&+_ga=/, "&_ga=")
            },
            gr = function (e, t) {
                if (t && t.action) {
                    ...
                    if ("get" == t.method.toLowerCase()) {
                        for (var r = t.childNodes || [], i = 0; i < r.length; i++)
                            if ("_ga" == r[i].name) {
                                ...
                                return
                            } r = T.createElement("input"), r.setAttribute("type", "hidden"), r.setAttribute("name", "_ga"), r.setAttribute("value", n), t.appendChild(r)
                    } else "post" == t.method.toLowerCase() && (t.action = mr(e, t.action))
                }
            };
        vr.prototype.S = function (e, t, r) {
            ...
            var s = this;
            this.T || (this.T = !0, d(T, "mousedown", i, !1), d(T, "keyup", i, !1)), r && d(T, "submit", function (t) {
                t = t || x.event;
        ...
        var br = /^(GTM|OPT)-[A-Z0-9]+$/,
            ...
            Sr = function (e) {
                ...
                return "dataLayer" != e.B && t("l", e.B), t("t", e.target), t("cid", e.ja), t("cidt", e.ka), t("gac", e.la), t("aip", e.ia), e.na && t("m", "sync"), t("cycle", e.G), n
            },
            xr = function (e, t, r) {
                this.U = ln, this.aa = t, (t = r) || (t = (t = nt(e, Nn)) && "t0" != t ? Lr.test(t) ? "_gat_" + A(nt(e, An)) : "_gat_" + A(t) : "_gat"), this.Y = t, Vn(new Xn(100), e) && (n(30), this.pa = !0)
            },
            Tr = function (e, t) {
                var n = t.get(bn);
                t.set(bn, function (t) {
            ...
            Cr = function (e, t) {
                if (t.get(e.U)) {
                    var n = 6e5;
                    e.pa && (n /= 10), L(e.Y, "1", t.get(_n), t.get(Mn), t.get(An), n)
                }
            },
            kr = function (e, t) {
                if (t.get(e.U)) {
                    ...
                    r(dt), r(vt), r(An), r(Cn), r(Ln), r(e.U), n.set(ot(an).F, i(t));
                    var s = e.aa;
                    n.map(function (e, t) {
                        s += p(e) + "=", s += p("" + t) + "&"
                    }), s += "z=" + Q(), c(s), t.set(e.U, "", !0)
                }
            },
            Lr = /^gtm\d+$/,
            Ar = function (e, t) {
                ...
                if (!n.get("dcLoaded")) {
                    r(n, 29), t = t || {};
                    var i;
                    t[On] && (i = A(t[On])), i = new xr(n, "https://stats.g.doubleclick.net/r/collect?t=dc&aip=1&_r=3&", i), Tr(i, n), n.set("dcLoaded", !0)
                }
            },
            Or = function (e) {
                if (!e.get("dcLoaded") && "cookie" == e.get(Bn)) {
                    r(e, 51);
                    var t = new xr(e);
                    Nr(t, e), Cr(t, e), e.get(t.U) && (e.set(zn, 1, !0), e.set(Un, _() + "/r/collect", !0))
                }
            },
            Mr = function () {
            ...
            _r, Dr = function (e, t, n) {
                if (!_r) {
                    ...
                    var i = x.name,
                        s = /^#?gaso=([^&]*)/;
                    if (i = (r = (r = r && r.match(s) || i && i.match(s)) ? r[1] : k("GASO")[0] || "") && r.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i)) L("GASO", "" + r, n, t, e, 0), window._udo || (window._udo = t), window._utcp || (window._utcp = n), e = i[1], m("https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (e ? "prefix=" + e + "&" : "") + Q(), "_gasojs");
                    _r = !0
                }
            },
            Pr = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
            Hr = function (e) {
                ...
                var r = this;
                this.b = new Z, this.filters = new q, t(Nn, e[Nn]), t(An, l(e[An])), t(On, e[On]), t(Mn, e[Mn] || b()), t(_n, e[_n]), t(Dn, e[Dn]), t(Pn, e[Pn]), t(Hn, e[Hn]), t(jn, e[jn]), t(Fn, e[Fn]), t(In, e[In]), t(qn, e[qn]), t(Rn, e[Rn]), t(Bn, e[Bn]), t(Ln, e[Ln]), t(kn, e[kn]), t(dt, 1), t(vt, "j47"), n(cn, U), n(hn, $), n(pn, z), n(dn, K), n(vn, nr), n(mn, rr), n(gn, R), n(yn, Y), n(En, V), n(Sn, J), n(Tn, Or), n(bn, W), n(wn, X), n(xn, Zn(this)), Br(this.b, e[Cn]), jr(this.b), this.b.set(mt, Mr()), Dr(this.b.get(An), this.b.get(Mn), this.b.get(_n))
            },
            Br = function (e, t) {
                if ("cookie" == nt(e, Bn)) {
                    er = !1;
                    ...
                    e: {
                        ...
                        if (i && !(1 > i.length)) {
                            ...
                            for (var s = 0; s < i.length; s++) {
                                ...
                                o = i[s].split(".");
                                var u = o.shift();
                                ("GA1" == u || "1" == u) && 1 < o.length ? (u = o.shift().split("-"), 1 == u.length && (u[1] = "1"), u[0] *= 1, u[1] *= 1, o = {
                                    H: u,
                                    s: o.join(".")
                                }) : o = void 0, o && r.push(o)
                            }
                            ...
                            if (0 != r.length) {
                                n(14), i = or(nt(e, Mn)).split(".").length, r = sr(r, i, 0);
                                if (1 == r.length) {
                                    r = r[0].s;
                                    break e
                                }
                                i = ar(nt(e, _n)), r = sr(r, i, 1), r = r[0] && r[0].s;
                                break e
                            }
                            n(12)
                        }
                    ...
                    r || (r = nt(e, Mn), i = nt(e, Pn) || b(), r = fr("__utma", i, r), void 0 != r ? (n(10), r = r.O[1] + "." + r.O[2]) : r = void 0), r && (e.data.set(Cn, r), er = !0)
                }
                r = e.get(Fn);
                if (s = y(T.location[r ? "href" : "search"], "_ga")) e.get(jn) ? (r = s.indexOf("."), -1 == r ? n(22) : (i = s.substring(r + 1), "1" != s.substring(0, r) ? n(22) : (r = i.indexOf("."), -1 == r ? n(22) : (s = i.substring(0, r), r = i.substring(r + 1), s != dr(r, 0) && s != dr(r, -1) && s != dr(r, -2) ? n(23) : (n(11), e.data.set(Cn, r)))))) : n(21);
                t && (n(9), e.data.set(Cn, p(t)));
                if (!e.get(Cn))
                    if (r = (r = x.gaGlobal && x.gaGlobal.vid) && -1 != r.search(/^(?:utma\.)?\d+\.\d+$/) ? r : void 0) n(17), e.data.set(Cn, r);
                    else {
                        n(8), r = x.navigator.userAgent + (T.cookie ? T.cookie : "") + (T.referrer ? T.referrer : ""), i = r.length;
                        for (s = x.history.length; 0 < s;) r += s-- ^ i++;
            ...
            jr = function (e) {
                ...
                if (i) {
                    var s = i.pathname || "";
                    "/" != s.charAt(0) && (n(31), s = "/" + s), e.set(xt, i.protocol + "//" + i.hostname + s + i.search)
                }
                r && e.set(At, r.width + "x" + r.height), r && e.set(Lt, r.colorDepth + "-bit");
                var r = T.documentElement,
                    o = (s = T.body) && s.clientWidth && s.clientHeight,
                    u = [];
                r && r.clientWidth && r.clientHeight && ("CSS1Compat" === T.compatMode || !o) ? u = [r.clientWidth, r.clientHeight] : o && (u = [s.clientWidth, s.clientHeight]), r = 0 >= u[0] || 0 >= u[1] ? "" : u.join("x"), e.set(Ot, r), e.set(_t, $n()), e.set(kt, T.characterSet || T.charset), e.set(Mt, t && "function" == typeof t.javaEnabled && t.javaEnabled() || !1), e.set(Ct, (t && (t.language || t.browserLanguage) || "").toLowerCase());
                if (i && e.get(Fn) && (t = T.location.hash)) {
                    t = t.split(/[?&#]+/), i = [];
                    for (r = 0; r < t.length; ++r)(f(t[r], "utm_id") || f(t[r], "utm_campaign") || f(t[r], "utm_source") || f(t[r], "utm_medium") || f(t[r], "utm_term") || f(t[r], "utm_content") || f(t[r], "gclid") || f(t[r], "dclid") || f(t[r], "gclsrc")) && i.push(t[r]);
                    0 < i.length && (t = "#" + i.join("&"), e.set(xt, e.get(xt) + t))
                }
            };
        ...
        Hr.prototype.send = function (e) {
            if (!(1 > arguments.length)) {
                var t, n;
                "string" == typeof arguments[0] ? (t = arguments[0], n = [].slice.call(arguments, 1)) : (t = arguments[0] && arguments[0][gt], n = arguments), t && (n = E(Fr[t] || [], n), n[gt] = t, this.b.set(n, void 0, !0), this.filters.D(this.b), this.b.data.m = {})
            }
        ...
        var Ir = function (e) {
                return "prerender" == T.visibilityState ? !1 : (e(), !0)
            },
            qr = function (e) {
                if (!Ir(e)) {
                    n(16);
            ...
            Ur = function (e) {
                if (o(e[0])) this.u = e[0];
                    ...
                    var t = Rr.exec(e[0]);
                    null != t && 4 == t.length && (this.c = t[1] || "t0", this.K = t[2] || "", this.C = t[3], this.a = [].slice.call(e, 1), this.K || (this.A = "create" == this.C, this.i = "require" == this.C, this.g = "provide" == this.C, this.ba = "remove" == this.C), this.i && (3 <= this.a.length ? (this.X = this.a[1], this.W = this.a[2]) : this.a[1] && (a(this.a[1]) ? this.X = this.a[1] : this.W = this.a[1]))), t = e[1], e = e[2];
                    if (!this.C) throw "abort";
                    if (this.i && (!a(t) || "" == t)) throw "abort";
                    if (this.g && (!a(t) || "" == t || !o(e))) throw "abort";
                    if (zr(this.c) || zr(this.K)) throw "abort";
                    if (this.g && "t0" != this.c) throw "abort"
                }
            },
            Wr, Xr, Vr, $r;
        Wr = new S, Vr = new S, $r = new S, Xr = {
            ec: 45,
            ecommerce: 46,
            linkid: 47
        };
        var Jr = function (e, t, n) {
                t == ti || t.get(Nn);
                var r = Wr.get(e);
                return o(r) ? (t.plugins_ = t.plugins_ || new S, t.plugins_.get(e) ? !0 : (t.plugins_.set(e, new r(t, n || {})), !0)) : !1
            },
            Kr = function (e, t, r, i, s) {
                if (!o(Wr.get(t)) && !Vr.get(t)) {
                    ...
                    if (br.test(t)) {
                        ...
                        "t0" != u && (i.target = u), C(String(e.get("trackingId"))) || (i.ja = String(e.get(Cn)), i.ka = Number(e.get(kn)), e = r.palindrome ? Er : wr, e = (e = T.cookie.replace(/^|(; +)/g, ";").match(e)) ? e.sort().join("").substring(1) : void 0, i.la = e), e = i.B, r = (new Date).getTime(), x[e] = x[e] || [], r = {
                            "gtm.start": r
                        }, s || (r.event = "gtm.js"), x[e].push(r), r = Sr(i)
                    }!r && Xr.hasOwnProperty(t) ? (n(39), r = t + ".js") : n(43), r && (r && 0 <= r.indexOf("/") || (r = (pt || g() ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + r), i = Zr(r), e = i.protocol, r = T.location.protocol, ("https:" == e || e == r || ("http:" != e ? 0 : "http:" == r)) && Yr(i) && (m(i.url, void 0, s), Vr.set(t, !0)))
                }
            },
            Qr = function (e, t) {
                var n = $r.get(e) || [];
            ...
            Gr = function (e, t) {
                Wr.set(e, t);
                for (var n = $r.get(e) || [], r = 0; r < n.length; r++) n[r]();
                $r.set(e, [])
            },
            Yr = function (e) {
                var t = Zr(T.location.href);
                return f(e.url, "https://www.google-analytics.com/gtm/js?id=") ? !0 : e.query || 0 <= e.url.indexOf("?") || 0 <= e.path.indexOf("://") ? !1 : e.host == t.host && e.port == t.port ? !0 : (t = "http:" == e.protocol ? 80 : 443, "www.google-analytics.com" == e.host && (e.port || t) == t && f(e.path, "/plugins/") ? !0 : !1)
            },
            Zr = function (e) {
                function t(e) {
                    ...
                    return e = e.pathname || "", f(e, "/") || (e = "/" + e), [t, "" + n, e]
                }
                ...
                var r = (n.protocol || "").toLowerCase(),
                    ...
                    s = n.search || "",
                    o = r + "//" + i[0] + (i[1] ? ":" + i[1] : "");
                return f(e, "//") ? e = r + e : f(e, "/") ? e = o + e : !e || f(e, "?") ? e = o + i[2] + (e || s) : 0 > e.split("/")[0].indexOf(":") && (e = o + i[2].substring(0, i[2].lastIndexOf("/")) + "/" + e), n.href = e, r = t(n), {
        ...
        ei.ga(), ei.D = function (e) {
            var t = ei.J.apply(ei, arguments),
                t = ei.f.concat(t);
            for (ei.f = []; 0 < t.length && !ei.v(t[0]) && !(t.shift(), 0 < ei.f.length););
            ei.f = ei.f.concat(t)
        }, ei.J = function (e) {
            for (var t = [], n = 0; n < arguments.length; n++) try {
                var r = new Ur(arguments[n]);
                r.g ? Gr(r.a[0], r.a[1]) : (r.i && (r.ha = Kr(r.c, r.a[0], r.X, r.W)), t.push(r))
            } catch (i) {}
            return t
        }, ei.v = function (e) {
            try {
                if (e.u) e.u.call(x, ti.j("t0"));
                else {
                    var t = e.c == ht ? ti : ti.j(e.c);
                    if (e.A) "t0" != e.c || ti.create.apply(ti, e.a);
                    else if (e.ba) ti.remove(e.c);
                    else if (t)
                        if (e.i) {
                            if (e.ha && (e.ha = Kr(e.c, e.a[0], e.X, e.W)), !Jr(e.a[0], t, e.W)) return !0
                        } else if (e.K) {
                        var n = e.C,
                            r = e.a,
        ...
        var ti = function (e) {
            n(1), ei.D.apply(ei, [arguments])
        };
        ti.h = {}, ti.P = [], ti.L = 0, ti.answer = 42;
        var ni = [An, Mn, Nn];
        ti.create = function (e) {
            var t = E(ni, [].slice.call(arguments));
            t[Nn] || (t[Nn] = "t0");
            var n = "" + t[Nn];
            return ti.h[n] ? ti.h[n] : (t = new Hr(t), ti.h[n] = t, ti.P.push(t), t)
        }, ti.remove = function (e) {
            for (var t = 0; t < ti.P.length; t++)
                if (ti.P[t].get(Nn) == e) {
                    ti.P.splice(t, 1), ti.h[e] = null;
                    break
                }
        }, ti.j = function (e) {
            return ti.h[e]
            ...
            var e = x[ht];
            if (!e || 42 != e.answer) {
                ti.L = e && e.l, ti.loaded = !0;
                var t = x[ht] = ti;
                Wn("create", t, t.create), Wn("remove", t, t.remove), Wn("getByName", t, t.j, 5), Wn("getAll", t, t.getAll, 6), t = Hr.prototype, Wn("get", t, t.get, 7), Wn("set", t, t.set, 4), Wn("send", t, t.send), Wn("requireSync", t, t.ma), t = Z.prototype, Wn("get", t, t.get), Wn("set", t, t.set);
                if (!g() && !pt) {
                    e: {
                ...
                g() || pt || !Vn(new Xn(1e4)) || (n(36), pt = !0), (x.gaplugins = x.gaplugins || {}).Linker = vr, t = vr.prototype, Gr("linker", vr), Wn("decorate", t, t.ca, 20), Wn("autoLink", t, t.S, 25), Gr("displayfeatures", Ar), Gr("adfeatures", Ar), e = e && e.q, u(e) ? ei.D.apply(ti, e) : n(50)
            }
        }, ti.da = function () {
            for (var e = ti.getAll(), t = 0; t < e.length; t++) e[t].get(Nn)
        };
        var ri = ti.N,
            ii = x[ht];
        ii && ii.r ? ri() : qr(ri), qr(function () {
            ei.D(["provide", "render", h])
        })
    }(window), define("google-analytics", function (e) {
        return function () {
            var t, n;
            return t || e.ga
        }
        ...
        return {
            ...
            adRollPixId: "QJ4YOWHQHVDK5OGCBY7BVU",
            TwitchClientID: "qqtkdyqqljy2jsutfdgbfvgtt73en8t",
            bannerSettings: {
                "default": [{
                    background: "#42385b",
    ...
    function (e) {
        ...
        var s = n.Model.extend({
            initialize: function () {
                ...
                }), i("require", "displayfeatures"), i("send", "pageview")
            },
            ...
            setApplication: function (e, t, n, r) {
                var s = {};
                e != undefined && (s.appName = e), t != undefined && (s.appId = t), n != undefined && (s.appVersion = n), r != undefined && (s.appInstallerId = r), i("set", s)
            },
            trackScreenView: function (e) {
                e == undefined && (e = ""), i("send", "screenview", {
                    screenName: e
                })
            },
            trackPageView: function (e, t) {
                e == undefined && (e = ""), t == undefined && (t = ""), i("send", "pageView", {
                    page: e,
                    title: t
                })
            },
            trackEvent: function (e, t, n, r) {
                e == undefined && (e = ""), t == undefined && (t = ""), n == undefined && (n = ""), r == undefined && (r = 0), i("send", "event", {
                    eventCategory: e,
                    eventAction: t,
                    eventLabel: n,
                    eventValue: r
            ...
            trackTiming: function (e, t, n, r) {
                e == undefined && (e = ""), t == undefined && (t = ""), r == undefined && (r = ""), n == undefined && (n = (new Date).getTime() - window.performance.timing.domComplete), i("send", "timing", {
                    timingCategory: e,
                    timingVar: t,
                    timingValue: n,
                    timingLabel: r
            ...
            trackSocial: function (e, t, n) {
                var r = {};
                e != undefined && (r.socialNetwork = e), t != undefined && (r.socialAction = t), n != undefined && (r.socialTarget = n), i("send", "social", r)
            },
            trackException: function (e, t) {
                e == undefined && (e = ""), t == undefined && (t = !1), i("send", "exception", {
                    exDescription: e,
                    exFatal: t
                })
            }
        ...
        var i = function () {
            this.app = null, this.currentPage = null, this.testBlob = null, this.pageCount = 0, this.testing = !1
        };
        return i.prototype.initialize = function () {
            ...
            if (t != "" && t != undefined && r != "" && r != undefined) {
                ...
                e.getJSON(i, function (e) {
                    e.states[r] && (s.testBlob = e.states[r], s.testing = !0, s.navigateToApp(t, null))
                })
            } else this.login()
        }, i.prototype.navigateToApp = function (e) {
            var t = this;
            if (e === this.appTag) return;
            ...
            return e("#container").append('<div id="page-' + ++this.pageCount + '" class="pt-page"></div>'), "#page-" + this.pageCount
        }, i.prototype.showPage = function (e) {
            if (e === this.currentPage) return;
            var t = this;
            t.currentPage && t.transitionOff(t.currentPage, function () {}), t.currentPage = e, t.transitionOn(e, function () {})
        }, i.prototype.transitionOn = function (e, t) {
            e.$el.hide(), e.$el.fadeIn("slow", t)
        ...
        var o = n.View.extend({
            ...
            initialize: function () {
                var e = this;
                e.options = r.bannerSettings, e.setBannerParams("default")
            },
            events: {
                "click #slide-in-banner-img": "doBannerClick"
            },
            doBannerClick: function (t) {
                i.trackEvent("SlideBanner", "Click", e(t.currentTarget).data("campaign"), 0), window.open(e(t.currentTarget).data("link"), "_blank")
            },
            setBannerParams: function (e) {
                var t = this;
                t.options[e] !== undefined ? t.params = t.pickRandomBannerByChance(t.options[e]) : t.params = t.pickRandomBannerByChance(t.options["default"]), t.render()
            },
            render: function () {
                var e = this,
            ...
            toggle: function (t, n) {
                var r = this;
                t == "on" ? (r.setBannerParams(n), e("#slide-in-banner").is(":hidden") && (i.trackEvent("SlideBanner", "On", r.params.campaign, 0), e("#slide-in-banner").slideToggle("fast"))) : t == "off" && (e("#slide-in-banner").is(":hidden") || e("#slide-in-banner").slideToggle("fast"))
            },
            isOff: function () {
        ...
        return n.View.prototype.close = function () {
            this.beforeClose && this.beforeClose(), this.undelegateEvents(), this.$el.empty(), this.stopListening(), this.unbind()
            ...
            var t = this;
            t.slideBannerOff(), t.bannerView.toggle("on", e)
        ...
        throw console.log("[RequireJS]  onError - message => " + e.message), e
        ...
        t == "google-analytics" && (require.undef(t), require.config({
            paths: {
                "google-analytics": "libs/google-analytics/analytics"
            }
        }), require(["jquery", "underscore", "bootstrap", "backbone", "google-analytics", "app"])), console.log("[RequireJS]  errback - message => " + e.message), console.log("[RequireJS]  errback - Failed ID => " + t)
    ...
    function (e) {
        ...
        function o() {
            ...
            if (!t) {
                var u = new Array(16);
                n = t = function () {
                    for (var e = 0, t; e < 16; e++)(e & 3) === 0 && (t = Math.random() * 4294967296), u[e] = t >>> ((e & 3) << 3) & 255;
                    return u
        ...
        function b(e, t, n) {
            ...
            var s = e.clockseq != null ? e.clockseq : m,
                ...
                a = o - g + (u - y) / 1e4;
            a < 0 && e.clockseq == null && (s = s + 1 & 16383), (a < 0 || o > g) && e.nsecs == null && (u = 0);
            if (u >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
            g = o, y = u, m = s, o += 122192928e5;
        ...
        function w(e, n, r) {
            var i = n && r || 0;
            typeof e == "string" && (n = e === "binary" ? new a(16) : null, e = null), e = e || {};
            var s = e.random || (e.rng || t)();
            s[6] = s[6] & 15 | 64, s[8] = s[8] & 63 | 128;
            if (n)
                for (var o = 0; o < 16; o++) n[i + o] = s[o];
            return n || p(s)
        }
        var t, n, r, i, s;
        e ? o() : u();
        var a = "function" == typeof Buffer ? Buffer : Array,
            f = [],
            l = {};
        for (var c = 0; c < 256; c++) f[c] = (c + 256).toString(16).substr(1), l[f[c]] = c;
        var d = t(),
            ...
            y = 0,
            E = w;
        E.v1 = b, E.v4 = w, E.parse = h, E.unparse = p, E.BufferClass = a, E._rng = t, E._mathRNG = n, E._nodeRNG = r, E._whatwgRNG = i, "undefined" != typeof module && module.exports ? module.exports = E : typeof define == "function" && define.amd ? define("uuid", [], function () {
            return E
        }) : (s = e.uuid, E.noConflict = function () {
            return e.uuid = s, E
        }, e.uuid = E)
...
(function () {
    (function (e, t) {
        var n = e;
        n.version = "0.9.17", n.protocol = 1, n.transports = [], n.j = [], n.sockets = {}, n.connect = function (e, r) {
            var i = n.util.parseUri(e),
                s, o;
    ...
    function (e, t) {
        ...
        n.parseUri = function (e) {
            var t = r.exec(e || ""),
                ...
                s = 14;
            while (s--) n[i[s]] = t[s] || "";
            return n.protocol === "localhost" && (n.port = n.host, n.host = n.protocol, n.protocol = "", n.authority = ""), n
    ...
    function (e, t) {
        ...
        e.Transport = n, t.util.mixin(n, t.EventEmitter), n.prototype.heartbeats = function () {
            ...
            if (e !== "") {
                ...
                if (n && n.length)
                    for (var r = 0, i = n.length; r < i; r++) this.onPacket(n[r])
            }
            return this
    ...
    function (e, t, n) {
        ...
        e.Socket = r, t.util.mixin(r, t.EventEmitter), r.prototype.of = function (e) {
            ...
            var n = e || this.transports,
                r;
            for (var i = 0, s; s = n[i]; i++)
                if (t.Transport[s] && t.Transport[s].check(this) && (!this.isXDomain() || t.Transport[s].xdomainCheck(this))) return new t.Transport[s](this, this.sessionid);
            return null
    ...
    function (e, t, n) {
        ...
        e.websocket = r, t.util.inherit(r, t.Transport), r.prototype.name = "websocket", r.prototype.open = function () {
            var e = t.util.query(this.socket.options.query),
                r = this,
                i;
    ...
    if ("undefined" != typeof window) var swfobject = function () {
        ...
        var e = "undefined",
            ...
            T = function () {
                ...
                else if (typeof u[["Active"].concat("Object").join("X")] != e) try {
    ...
    (function () {
        ...
        location.protocol == "file:" && e.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."), WebSocket = function (e, t, n, r, i) {
            ...
            var t;
            if (e.type == "open" || e.type == "error") t = this.__createSimpleEvent(e.type);
            else if (e.type == "close") t = this.__createSimpleEvent("close");
            else {
    ...
    function (e, t, n) {
    ...
    }("undefined" != typeof io ? io.Transport : module.exports, "undefined" != typeof io ? io : module.parent.exports, this), typeof define == "function" && define.amd && define("socketio", [], function () {
        return io
    })
})(), BlobCastClient.prototype.createActionPacket = function (e, t) {
        var n = t ? t : {};
        return n.type = "Action", n.appId = this.appId, n.userId = this.myUserId, n.action = e, n
    }, BlobCastClient.prototype.connectToService = function (e, t, n) {
        console.log("ConnectToService"), this.disconnectFromService();
        var r = this.server + "/room",
            i = this;
        e && (r += "/" + e), r += "?userId=" + i.myUserId, $.ajax({
            url: r,
            type: "GET",
            crossDomain: !0,
            dataType: "json",
            success: function (e) {
                ...
                e.hasOwnProperty("joinAs") && (i.joinAs = e.joinAs), e.hasOwnProperty("apptag") && (i.appTag = e.apptag), e.hasOwnProperty("appid") && (i.appId = e.appid);
                if (e.hasOwnProperty("joinAs") && e.joinAs === "full") return n(new Error("The room is full"));
                var r = e.server;
                i.socket = io.connect(r + ":38203", {
                    ...
                    console.log("[BlobcastClient] Socket connect."), i.retries = 0, i.isConnected == 0 && (t(i.appId, i.joinAs), i.isConnected = !0)
                }), i.socket.on("error", function (e) {
                    console.log("[BlobcastClient] Socket error =>" + e + ".")
                }), i.socket.on("reconnect", function (e) {
                    i.retries = 0, console.log("[BlobcastClient] Socket reconnect #" + e + ".")
                    ...
                    console.log("[BlobcastClient] Socket reconnecting #" + e + "."), i.retries == i.maxRetries && setTimeout(function () {
                        i.socket && (i.delegate.onDisconnectedFromService(), i.socket = null, console.log("[BlobcastClient] Socket max # of retries hit!  Disconnecting."))
                    }, 5e3), i.retries++
                    ...
                    console.log("[BlobcastClient] Socket reconnect_failed."), i.socket && (i.delegate.onDisconnectedFromService(), i.socket.disconnect(), i.socket = null, console.log("[BlobcastClient] Socket done attempting to reconnect!  Disconnecting."))
                }), i.socket.on("disconnect", function () {
                    i.isConnected = !1, i.retries = 0, console.log("[BlobcastClient] Socket disconnect.")
        ...
        var r = this;
        n.twitch !== undefined && (r.myUserId = n.twitch._id.toString()), this.connectToService(e, function (i, s) {
        ...
        this.socket && (console.log("DisconnectfromService"), this.socket.disconnect(), this.socket = null)
    }, BlobCastClient.prototype.send = function (e) {
        this.socket.emit("msg", e)
    }, BlobCastClient.prototype.leaveRoom = function () {
        if (!this.currentRoomId) return;
        this.send(this.createActionPacket("LeaveRoom")), this.currentRoomId = null
        ...
        if (e.type == "Result") e.action == "CreateRoom" ? e.success ? (this.currentRoomId = e.roomId, this.delegate && this.delegate.onRoomCreated && this.delegate.onRoomCreated(this.currentRoomId)) : this.delegate && this.delegate.onCreateRoomFail && this.delegate.onCreateRoomFail(new Error(e.error)) : e.action == "JoinRoom" ? e.success ? this.currentRoomId ? (this.currentRoomId = e.roomId, this.delegate && this.delegate.onRoomRejoined && this.delegate.onRoomRejoined(this.currentRoomId)) : (this.currentRoomId = e.roomId, this.delegate && this.delegate.onRoomJoined && this.delegate.onRoomJoined(this.currentRoomId)) : this.delegate && this.delegate.onJoinRoomFail && this.delegate.onJoinRoomFail(new Error(e.error)) : e.action == "LockRoom" ? e.success ? this.delegate.onRoomLocked() : this.delegate.onLockRoomFail() : e.action == "StartSession" ? this.delegate.onStartSessionResult(e.success, e.module, e.name, e.response) : e.action == "StopSession" ? this.delegate.onStopSessionResult(e.success, e.module, e.name, e.response) : e.action == "GetSessionStatus" ? this.delegate.onGetSessionStatusResult(e.success, e.module, e.name, e.response) : e.action == "SendSessionMessage" && this.delegate.onSendSessionMessageResult(e.success, e.module, e.name);
        else if (e.type == "Event") {
            if (this.currentRoomId != e.roomId) return;
            e.event == "CustomerJoinedRoom" ? this.delegate && this.delegate.onCustomerJoinedRoom && this.delegate.onCustomerJoinedRoom(e.customerUserId, e.customerName) : e.event == "CustomerMessage" && this.delegate && this.delegate.onCustomerSentMessage && this.delegate.onCustomerSentMessage(e.userId, e.message), e.event == "RoomBlobChanged" ? this.delegate && this.delegate.onRoomBlobChanged && this.delegate.onRoomBlobChanged(e.blob) : e.event == "CustomerBlobChanged" ? this.delegate && this.delegate.onCustomerBlobChanged && this.delegate.onCustomerBlobChanged(e.blob) : e.event == "RoomDestroyed" && (this.delegate && this.delegate.onRoomDestroyed && this.delegate.onRoomDestroyed(), this.socket.disconnect(), this.currentRoomId = null)
        }
    ...
    }(this)), define("models/blobcastmodel", ["jquery", "underscore", "backbone", "app", "uuid", "blobcast", "settings", "analytics", "jquery-cookie"], function (e, t, n, r, i, s, o, u) {
        function f(e) {
            var t = "test";
            try {
                return e.set(t, "1"), e.remove(t), !0
            } catch (n) {
                return !1
            }
        }
        ...
        var a = n.Model.extend({
                ...
                connect: function (e, t, n) {
                    var r = this;
                    this.client.joinRoom(e, t, n), this.set("username", t)
                },
                disconnect: function () {
        ...
        return h.prototype.onJoinRoomFail = function (e) {
            ...
            this.model.set("connected", !0), this.model.useStorage && (this.model.storage.set("username", this.model.get("username")), this.model.storage.set("roomid", e)), this.model.delegate && this.model.delegate.onRoomRejoined({
                appId: this.model.client.appId,
                appTag: this.model.client.appTag
            })
        }, h.prototype.onDisconnectedFromService = function () {
            console.log("disconnected"), this.model.set("connected", !1), this.model.delegate.onDisconnected()
            ...
            this.model.unset("customerBlob", {
                silent: !0
            }), this.model.set("customerBlob", e), this.model.delegate && (this.model.delegate.onCustomerBlobChanged(e), e.events && Array.isArray(e.events) && u.trackEvents(e.events))
        }, h.prototype.onRoomBlobChanged = function (e) {
            this.model.unset("roomBlob", {
                silent: !0
            }), this.model.set("roomBlob", e), this.model.delegate && this.model.delegate.onRoomBlobChanged(e)
        ...
        var o = s.extend({
            ...
            initialize: function () {
                s.prototype.initialize.apply(this), s.prototype.delegate = new u;
                var e = this;
                if (r.isTesting()) {
                    var t = r.getTestData();
                    e.set("roomBlob", t.roomBlob), e.set("customerBlob", t.customerBlob), e.set("username", t.customerBlob.playerName)
                }
                this.save()
            }
        });
        ...
        }, u.prototype.onRoomRejoined = function (e) {}, u.prototype.onDisconnected = function () {
            n.modalDialog({
                title: "Disconnected",
                message: "You have been disconnected.",
                restart: !0
            }), r.login()
        }, u.prototype.onRoomBlobChanged = function (e) {}, u.prototype.onCustomerBlobChanged = function (e) {}, new o
    }), define("adroll", ["jquery", "underscore", "backbone", "settings"], function (e, t, n, r, i) {
        var s = n.Model.extend({
            initialize: function () {
                window.adroll_adv_id = r.adRollAdvId, window.adroll_pix_id = r.adRollPixId;
                var e = document.createElement("script"),
                    t = "https:" == document.location.protocol ? "https://s.adroll.com" : "http://a.adroll.com";
                e.setAttribute("async", "true"), e.type = "text/javascript", e.src = t + "/j/roundtrip.js", ((document.getElementsByTagName("head") || [null])[0] || document.getElementsByTagName("script")[0].parentNode).appendChild(e)
            }
        });
        return new s
    }),
    function (e) {
        ...
        r.api = function (i, s) {
            if (!r._config.session) throw new Error("You must call init() before api()");
            var o = i.params || {};
            s = s || function () {};
            var u = !!r._config.session.token,
                a = r.baseUrl + (i.method || "");
            u && (o.oauth_token = r._config.session.token), e.ajax({
                url: a + "?" + e.param(o),
                dataType: "jsonp",
                timeout: t
            }).done(function (e) {
                ...
                r.log("API Error:", e.error + ";", e.message), u && e.status === n.unauthorized ? r.logout(function () {
                    s(e, null)
                }) : s(e, null)
            }).fail(function () {
    ...
    function () {
        var e = function (e, t) {
            if (!e.clientId) throw new Error("client id not specified");
            Twitch._config.clientId = e.clientId, Twitch._initSession(), typeof t == "function" && Twitch.getStatus(t)
        };
        Twitch.extend({
            init: e
        })
        ...
        var e = "twitch_oauth_session",
            ...
            r = function (e) {
                Twitch.api({
                    ...
                    var r;
                    if (t) {
                        Twitch.log("error encountered updating session:", t), e && e(t, null);
                        return
                    }
                    if (!n.token.valid) {
                        Twitch.logout(e);
            ...
            s = function (e, t) {
                typeof e == "function" && (t = e), typeof t != "function" && (t = function () {});
            ...
            o = function (e) {
                if (!e.scope) throw new Error("Must specify list of requested scopes");
                var n = {
                    response_type: "token",
                ...
                if (!n.client_id) throw new Error("You must call init() before login()");
            ...
            u = function (t) {
                Twitch._config.session = {}, Twitch._storage.removeItem(e), Twitch.events.emit("auth.logout"), typeof t == "function" && t(null)
            },
            a = function () {
                var t;
                ...
                document.location.hash.match(/access_token=(\w+)/) && (Twitch._config.session = n(), window.JSON && Twitch._storage.setItem(e, JSON.stringify(Twitch._config.session))), s(function (e, t) {
    ...
    function () {
        ...
        function t(e, t, n, r, i) {
            this.type = e, this.listener = t, this.scope = n, this.once = r, this.instance = i
        }
        t.prototype.fire = function (e) {
            ...
            return this._events.hasOwnProperty(e) || (this._events[e] = []), this._events[e].push(new t(e, n, r, i, this)), this.emit("newListener", e, n, r, i), this._maxListeners && !this._events[e].warned && this._events[e].length > this._maxListeners && (Twitch.log("Possible EventEmitter memory leak detected. " + this._events[e].length + " listeners added. Use emitter.setMaxListeners() to increase limit."), this._events[e].warned = !0), this
        }, e.prototype.on = e.prototype.addListener, e.prototype.once = function (e, t, n) {
            ...
            }), this._events[e] && this._events[e].length === 0 && delete this._events[e], this
    ...
    }(), define("twitch-sdk", function () {}), define("twitch-model", ["jquery", "underscore", "backbone", "settings", "twitch-sdk", "jquery-cookie"], function (e, t, n, r, i) {
        var s = n.Model.extend({
            user: undefined,
            initialize: function () {},
            setup: function (t) {
                var n = this;
                e(".twitch-logout").hide(), Twitch.init({
                    clientId: r.TwitchClientID
                }, function (r, i) {
                    r && console.log(r), i.authenticated && (e(".twitch-connect").hide(), e(".twitch-logout").show(), i.authenticated == 1 && n.getUser(t))
                })
            },
            login: function () {
            ...
            logout: function () {
                Twitch.logout(), this.user = undefined, e(".twitch-connect").show(), e(".twitch-logout").hide()
            },
            getUser: function (e) {
                var t = this;
        ...
        var t = "drawer",
            ...
            r = {
                init: function (n) {
                    return n = e.extend({
                        ...
                        var i = this,
                            ...
                            u = o.data(t);
                        if (!u) {
                            n = e.extend({}, n), o.data(t, {
                                options: n
                            });
                            var a = new IScroll("." + r.settings["class"].nav, n.iscroll);
                            n.showOverlay && r.addOverlay.call(i), e("." + r.settings["class"].toggle).on("click." + t, function () {
                                return r.toggle.call(i), a.refresh()
                            }), e(window).resize(function () {
                                return r.close.call(i), a.refresh()
                ...
                open: function (i) {
                    var o = e(this);
                    return i = o.data(t).options, n && o.on("touchmove." + t, function (e) {
                        e.preventDefault()
                    }), o.removeClass(r.settings["class"].close).addClass(r.settings["class"].open).css({
                        overflow: "hidden"
                    }).drawerCallback(function () {
                        r.settings.state = !0, o.trigger(r.settings.events.opened)
                    })
                },
                close: function (i) {
                    var o = e(this);
                    return i = o.data(t).options, n && o.off("touchmove." + t), o.removeClass(r.settings["class"].open).addClass(r.settings["class"].close).css({
                        overflow: "auto"
                    }).drawerCallback(function () {
                        r.settings.state = !1, o.trigger(r.settings.events.closed)
                    })
                },
                destroy: function () {
                    return this.each(function () {
    ...
    function (e, t, n) {
    ...
    }(window, document, Math), define("iscroll", function () {}), define("views/signin", ["jquery", "underscore", "backbone", "models/customer", "analytics", "adroll", "twitch-model", "text!templates/signin.html", "drawer", "iscroll"], function (e, t, n, r, i, s, o, u) {
        var a = n.View.extend({
            model: r,
            appName: "Main",
            appId: "main",
            ...
            initialize: function (e) {
                this.checkWebSocket(), this.joinRoom(), this.render()
            },
            events: {
            ...
            toggleDrawer: function () {
                ...
                t == '<i class="fa fa-close fa-2x"></i>' ? (e("#jbg-settings-btn").html('<i class="fa fa-cog fa-2x"></i>'), e("#jbg-settings-btn").removeClass("drawer-hamburger-jbg-dark")) : (e("#jbg-settings-btn").html('<i class="fa fa-close fa-2x"></i>'), e("#jbg-settings-btn").addClass("drawer-hamburger-jbg-dark"))
            },
            joinRoom: function () {
                if (this.hasWs == 0) return n.modalDialog({
                    type: "error",
                    title: "Error",
            ...
            twitchLogout: function () {
                o.logout(), e("#username").val(""), e("#username").prop("disabled", !1), e("#jbg-settings-btn").html('<i class="fa fa-cog fa-2x"></i>'), e("#jbg-settings-btn").removeClass("drawer-hamburger-jbg-dark"), e(".drawer").drawer("close")
            },
            onTwitchLogin: function (t) {
                var r = t.name;
                r.length > 12 && (r = r.substr(0, 11), r += "…"), e("#username").val(r), e("#username").prop("disabled", !0), n.hasHashRoomCode() && e("#button-join").trigger("click")
            },
            ...
            onResize: function () {
                var t = e(window).width(),
                    ...
                    r = 0,
                    i = 0;
                t > 500 ? r = 500 : r = t, i = r / 3.1636, e("#jbg_logo").css("width", r), e("#jbg_logo").attr("width", r), e("#jbg_logo").css("height", i), e("#jbg_logo").attr("height", i)
            },
            checkWebSocket: function () {
                try {
                    websocket = new WebSocket("wss:echo.websocket.org"), websocket.close("")
                } catch (e) {
                    this.hasWs = 1
                }
            },
        ...
        var i = n.View.extend({
            ...
            render: function (n) {
                if (n.hasOwnProperty("init") && n.init == 1) return;
                var i = t.template(r, n);
                this.$el.html(i), e("#modal-dialog").modal(), n.restart != undefined && (this.restartOnClose = n.restart)
            },
            closeModal: function (e) {
                this.restartOnClose == 1 && (location.reload(), console.log("Modle close-modal clicked"))
            }
        });
        return i
    });